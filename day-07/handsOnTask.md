...
# 🚀 Day-7: High Availability with MIGs and Load Balancing

## 🎯 Goal
Learned how to deploy a production-ready, highly available web application in GCP using **Managed Instance Groups (MIGs)**, **HTTP(S) Load Balancer**, and **health checks**, with observability through **Cloud Logging** — all using the **GCP Console**.
...
4. Set:
   - Name: `ha-lb-auto-scaling-demo`
   - Backend configuration:
     - Create backend service
     - Add the MIG (`ha-manages-instance`)
...
1. Go to **Network services → Load balancing**
2. Click into `ha-lb-auto-scaling-demo`
